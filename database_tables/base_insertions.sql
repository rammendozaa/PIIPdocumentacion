...
VALUES 
(999999, "Placement quiz", "This is a quiz dedicated for placement", "32");

INSERT INTO QUESTIONNAIRE_QUESTION (questionnaire_id, question, answer, option_1, option_2, option_3)
VALUES
(999999,"What is a correct syntax to output 'Hello World' in C++?",
"cout << \"Hello World\";",
"Console.WriteLine(\"Hello World\");",
"System.out.println(\"Hello World\");",
"print (\"Hello World\");"),
(999999,"How do you insert COMMENTS in C++ code?",
"// This is a comment",
"/* This is a comment",
"# This is a comment",
"-> This is a comment"),
(999999,"Which data type is used to create a variable that should store text?",
"string",
"txt",
"String",
"myString"),
(999999, "How do you create a variable with the numeric value 5?",
"int x = 5;",
"x = 5;",
"double x = 5;",
"num x = 5"),
(999999,"How do you create a variable with the floating number 2.8?",
"double x = 2.8;",
"int x = 2.8;",
"byte x = 2.8;",
"x = 2.8;"),
(999999,"Which method can be used to find the length of a string?",
"length()",
"getLength()",
"getSize()",
"len()"),
(999999,"Which operator is used to add together two values?",
"+",
"*",
"plus",
"&"),
(999999,"Which operator can be used to compare two values?",
"==",
"<>",
"><",
"="),
(999999,"To declare an array in C++, define the variable type with:",
"[]",
"{}",
"()",
"createArray()"),
(999999,"Array indexes start with",
"0",
"1",
"2",
"3"),
(999999,"How do you create a function in C++?",
"functionName()",
"functionName[]",
"functionName.",
"(functionName)"),
(999999,"How do you call a function in C++",
"functionName();",
"(functionName)",
"functionName",
"functionName[];"),
(999999,"Which keyword is used to create a class in C++?",
"class",
"MyClass",
"class()",
"className"),
(999999,"What is the correct way to create an object called myObj of MyClass?",
"class myObj = new MyClass();",
"class MyClass = new myObj();",
"new myObj = MyClass();",
"MyClass myObj;"),
(999999,"Which operator is used to multiply numbers?",
"*",
"#",
"%",
"x"),
(999999,"How do you start writing an if statement in C++?",
"if (x > y)",
"if x > y:",
"if (x > y) then",
"if (x > y) else"),
(999999,"How do you write a loop in C++",
"while( x > y)",
"while x > y {",
"while x > y :",
"x > y while {"),
(999999,"What’s an algorithm?",
"A set of step-by-step instructions to resolve a problem",
"Patterns and trends used to solve a problem",
"A programming language",
"start method"),
(999999,"What are algorithms used for?",
"To plan out the solution to a problem",
"As a platform to program a solution",
"To test a solution to a problem",
"For fun"),
(999999,"How can an algorithm be represented?",
"As a flowchart or pseudocode",
"As a flowchart",
"As pseudocode",
"draw"),
(999999,"What is a flowchart?",
...
"A drawing"),
(999999,"What is pseudocode?",
"A way of describing a set of instructions that doesn’t use specific syntax",
"A high-level language that has specific syntax",
"A diagram that represents a set of instructions",
"A sub variant of C++"),
(999999,"What’s the time, space complexity of the following code? 
...
"O(N * M) time, O(N + M) space"),
(999999,"What is the time complexity of the following code:
int a = 0;
for (i = 0; i < N; i++) {
		for (j = N; j > i; j--) {
			a = a + i + j;
...
"O(N^2)",
"O(N^2LogN)"),
(999999,"What does it mean when we say that an algorithm X is asymptotically more efficient than Y?",
...
"O(sqrt(N))",
"O(N/2)"),
(999999,"Which of the following best describes the useful criterion for comparing the efficiency of algorithms?",
"Both of the above",
"Time",
"Memory",
"None of the above"),
(999999,"How is time complexity measured?",
...
"None of the above"),
(999999,"What will be the time complexity of the following code?",
"O(log K (N))",
"O(N)",
"O(K)",
"O(log N (K))"),
(999999,"What are soft skills?",
"All of the above",
...
(999999,"START is an acronym for ..",
